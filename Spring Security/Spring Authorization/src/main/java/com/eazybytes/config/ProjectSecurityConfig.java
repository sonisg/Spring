...
public class ProjectSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/myAccount").hasRole("USER").antMatchers("/myBalance").hasAnyRole()
				.antMatchers("/myLoans").authenticated().antMatchers("/myCards").hasRole("MANAGER").antMatchers("/notices")
